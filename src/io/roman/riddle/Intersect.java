...
/**
 * Given two sorted Arrays with integers return an array that contains the intersection.
 * The first Array is large, the second is smaller
...
public class Intersect {
	...
	static int arrayOneValues = 100;
	static int arrayTwoValues = 1000;
